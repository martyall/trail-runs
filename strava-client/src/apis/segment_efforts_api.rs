...
pub async fn get_efforts_by_segment_id(configuration: &configuration::Configuration, params: GetEffortsBySegmentIdParams) -> Result<ResponseContent<GetEffortsBySegmentIdSuccess>, Error<GetEffortsBySegmentIdError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetEffortsBySegmentIdSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_segment_effort_by_id(configuration: &configuration::Configuration, params: GetSegmentEffortByIdParams) -> Result<ResponseContent<GetSegmentEffortByIdSuccess>, Error<GetSegmentEffortByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetSegmentEffortByIdSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
